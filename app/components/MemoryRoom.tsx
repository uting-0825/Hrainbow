...
const loadComputerMode = () => import('./computer/ComputerMode');
const loadGoldenRetrieverGame = () => import('./GoldenRetrieverGame');
const loadRadioExperience = () => import('./RadioExperience');
const loadTravelMapModal = () => import('./TravelMapModal');
